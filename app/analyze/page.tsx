...
export default function AnalyzePage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#e8e8e8', position: 'relative', zIndex: 10 }}>
      ...
      <nav className="navbar navbar-expand-lg sticky-top" style={{ backgroundColor: '#e8e8e8', zIndex: 1050 }}>
        <div className="container-fluid">
          <div className="d-flex justify-content-between align-items-center w-100 px-3">
            ...
            <Link href="/" className="nav-link text-black fw-medium text-decoration-none">
              Home
            </Link>
          </div>
        </div>
      ...
      {report && (
        <div id="report-section" className="mt-5">
          {(() => {
            ...
            return (
              <div>
                {/* Header Card */}
                <div className="card shadow-lg border-0 rounded-4 mb-4" style={{ backgroundColor: '#ffffff' }}>
                  <div className="card-body p-4 p-md-5">
                    ...
                    {/* Main Verdict Card */}
                    <div className="bg-light rounded-4 p-4 p-md-5 border border-primary border-2">
                        ...
                        <div className="flex-grow-1">
                          ...
                          <div className="d-flex flex-wrap align-items-center gap-4">
                            <div className="d-flex align-items-baseline gap-2">
                              ...
                              <span className="text-secondary fs-5">/100</span>
                            </div>
                ...
                <div className="card shadow-lg border-0 rounded-4 mb-4" style={{ backgroundColor: '#ffffff' }}>
                  <div className="card-body p-4 p-md-5">
                    <h3 className="h2 fw-bold text-black mb-4 d-flex align-items-center gap-3">
                      <span className="badge bg-primary bg-opacity-25 text-primary rounded-3 d-inline-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
                        📊
                      </span>
                      Score Breakdown
                    </h3>
                    <div className="row g-4">
                      {Object.entries(report.breakdown).map(([key, score]) => (
                        <div key={key} className="col-md-6">
                          <div className="p-4 bg-light rounded-4 border border-secondary border-opacity-25">
                  ...
                  <div className="card-body p-4 p-md-5">
                    ...
                    <div className="d-flex flex-column gap-3">
                      {report.fixPlan.fixes.map((fix, index) => (
                        <div key={index} className="bg-primary bg-opacity-10 border-start border-primary border-4 p-4 rounded-4">
                          <div className="d-flex align-items-start gap-3">
                            <div className="badge bg-primary text-white rounded-3 d-inline-flex align-items-center justify-content-center fw-bold" style={{ width: '32px', height: '32px', flexShrink: 0 }}>
                              {index + 1}
                            </div>
                            <div className="flex-grow-1">
                ...
                <div className="card shadow-lg border-0 rounded-4 mb-4" style={{ backgroundColor: '#ffffff' }}>
                  <div className="card-body p-4 p-md-5">
                    <h3 className="h2 fw-bold text-black mb-4">Screening Risk Analysis</h3>
                    <div className="mb-4">
                      <span className={`badge px-4 py-2 rounded-pill fw-bold border ${getRiskColor(report.screeningRisk.level)}`}>
                    ...
                    <div className="d-flex flex-column gap-3 mt-4">
                      {report.screeningRisk.reasons.map((reason, index) => (
                        <div key={index} className="d-flex align-items-start gap-3 p-3 bg-light rounded-4">
                          <span className="text-primary fw-bold">•</span>
                          <p className="text-black mb-0">{reason}</p>
                        </div>
                      ))}
                    </div>
                    <div className="mt-4 p-3 bg-info bg-opacity-10 border border-info border-opacity-25 rounded-4">
                      <p className="small text-black mb-0 fst-italic">{report.screeningRisk.disclaimer}</p>
                    </div>
                  </div>
                </div>
